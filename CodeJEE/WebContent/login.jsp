...
<body>
        ...
        <div class="main-menu">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="index.html"><img src="./images/logo2.jpg" alt="logo"></a>
    ...
    <section class="static about-sec">
        <div class="container">
            ...
            <div class="form">
                <form method="get" action="Auth2">
                    <div class="row">
                        <div class="col-md-5">
                            <input placeholder="Enter User Name" name="nom" required>
                        ...
                        <div class="col-lg-8 col-md-12">
                            <input name="btn" type="submit" value="Login" class="btn black"  > 
