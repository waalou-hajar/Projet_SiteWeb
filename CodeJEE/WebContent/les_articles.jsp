...
<%@page import="com.model.Article"%>
	...
	PreparedStatement stmt = con.prepareStatement("select * from Article;");
...
<tr><td>Id</td><td>Description</td><td>Prix</td><td>Qantité</td><td>Img</td><td>Option Admin </td></tr>
		<tr>
		<%
		...
		<tr>
			...
			<td><%=resultats.getInt(4)%></td>
			<td><img src="C:\Users\hajar\Desktop\img_site\<%=resultats.getString(5)%>" ></td>
			<td><a href="formSUPArticle.html">Supprimer</a></td>
